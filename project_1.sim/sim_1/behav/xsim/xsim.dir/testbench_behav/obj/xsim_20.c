...
extern "C"
{
	...
	DPI_DLLISPEC extern void* DPICreateContext(int scopeId, char* IP, char* SP, int callerIdx);
	...
	DPI_DLLISPEC extern char* DPIGetCallingProcess();
...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x417550)) ;
...
extern "C" {
	...
	extern void subprog_m_ca40c5035c33f6ca_556ead11_2064(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		IP = svGetScopeIP();
		char *callingProcess = DPIGetCallingProcess() ;
		char* SP ;
		void* oldSPcontext = DPIGetCurrentContext();
		SP = DPIInitializeFunction(IP + 389776, 224, 166856) ;
		char driver0[32] ;
		...
		DPIScheduleTransactionBlocking(IP +389272, driver0, (char*)(&copyArg_0_0), 0, 31) ;
		const char* copyArg_1_1[1] ;
		copyArg_1_1[0] = ( arg1) ;
		DPIScheduleTransactionBlocking(IP +389328, driver1, (char*)(&copyArg_1_1), 0, 31) ;
		const char* copyArg_2_2[1] ;
		copyArg_2_2[0] = ( arg2) ;
		DPIScheduleTransactionBlocking(IP +389384, driver2, (char*)(&copyArg_2_2), 0, 31) ;
		char copyArg_3_3[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +389440, driver3, (char*)(&copyArg_3_3), 0, 31) ;
		const char* copyArg_4_4[1] ;
		copyArg_4_4[0] = ( arg4) ;
		DPIScheduleTransactionBlocking(IP +389496, driver4, (char*)(&copyArg_4_4), 0, 31) ;
		char copyArg_5_5[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +389552, driver5, (char*)(&copyArg_5_5), 0, 31) ;
		char* oldSP = *((char**)(callingProcess +80)) ; 
		DPIInvokeFunction(callingProcess, SP, (void*)(subprog_m_ca40c5035c33f6ca_556ead11_2064), IP) ;
		DPIDeleteFunctionInvocation(SP) ;
		*((char**)( callingProcess + 80)) = oldSP ; 
